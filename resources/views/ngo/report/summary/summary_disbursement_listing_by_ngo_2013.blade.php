                    ...
                    @if(count($tmpDsCount)>0)
                        ...
                        @foreach($dsCore as $row)
                            ...
                            if (count($tmpDisbSum) > 0) {
                                $TotalOwn2013 = $tmpDisbSum->TotalOwn2013;
                                $TotalOther2013 = $tmpDisbSum->TotalOther2013;
                                $TotalNgo2013 = $tmpDisbSum->TotalNgo2013;
                                $Total2013 = $tmpDisbSum->Total2013;
                                ...
                                $gTotalOwn2013 = +$TotalOwn2013;
                                $gTotalOther2013 = +$TotalOther2013;
                                $gTotalNgo2013 += $TotalNgo2013;
                                $gTotal2013 += $Total2013;
                                ...
                                $getSum = $TotalOwn2013 + $TotalOther2013 + $TotalNgo2013 + $Total2013;
                            ...
                            @if((count($tmpDisbSum)>0) && ($getSum >0) ||(count($dsCore) == ($countRID)))
                                <table border="0" width="100%" id="{{++$isProjectNull}}"
                                       style="border-collapse: collapse">
                                    <tr>
                                        <td align="center">
                                            <table class="fontNormal" border="0" cellpadding="2"
                                                   style="border-collapse: collapse"
                                                   width="100%"
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center"><font color="#800000" size="3"><b>
                                                                Summary of Disbursement by Project for the Year 2015</b></font>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="42%">NGO's Name:</td>
                                                    <td width="57%"><b><font
                                                                    color="#008000"> {{$row->Org_Name_E}}</font></b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="42%">Project Duration From:</td>
                                                    <td width="57%"><b><font color="#800080">{{$fromDate}}</font></b>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            @if($toExcel==false)
                                                <div align="right" class="fontNormal">
                                                    <a href="#none" onclick="toExcel();"><img
                                                                ...
                                                                src="/images/print.gif" width="18" height="18"
                                                                border="0"
                                                ...
                                                <table class="fontTiny" width="100%" border="1" bordercolor="#CCCCCC"
                                                    ...
                                                    <tr>
                                                        <th width="20" rowspan="2" bgcolor="#ECE9D8"
                                                            ...
                                                            <font
                                                                    size="1">No</font></th>
                                                        <th width="498" rowspan="2" bgcolor="#ECE9D8"><font size="1">Project
                                                                Name</font>
                                                        </th>
                                                        <th rowspan="2" bgcolor="#ECE9D8"><font size="1">Status</font>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <td height="25" bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">Own
                                                                    Resource</font></b>
                                                        </td>
                                                        <td bgcolor="#ECE9D8" align="center"><b><font size="1">Multilateral/<br>
                                                                    Bilateral</font></b></td>
                                                        <td bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">NGOs</font></b></td>
                                                        <td bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">Total</font></b></td>
                                                        <td height="25" bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">Own
                                                                    Resource</font></b>
                                                        </td>
                                                        ...
                                                        <td bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">Total</font></b></td>
                                                        <td bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">2016</font></b></td>
                                                        <td bgcolor="#ECE9D8" align="center"><b><font
                                                                        size="1">2017</font></b></td>
                                                    ...
                                                    @if(count($tmpDs)>0)
                                                        @foreach($tmpDs as $row)
                                                            <?php
                                                            $own2013 = MyUtility::e2z($row->own2013);
                                                            $other2013 = MyUtility::e2z($row->other2013);
                                                            $ngo2013 = MyUtility::e2z($row->ngo2013);
                                                            ...
                                                            $sumAmountProject = $own2013 + $other2013 + $ngo2013 +$own2014 + $other2014 + $ngo2014 + $own2015 + $other2015 + $ngo2015 + $plan2016 + $plan2017 + $plan2018;
                                ...
                                <span id="printRegion5">
                                                                        ...
                                                                        <td align="right"><font
                                                                                    size="1">{{MyUtility::formatThousand($row->own2013)}}</font>
                                                                        </td>
                                                                        <td align="right"><font
                                                                                    size="1">{{MyUtility::formatThousand($row->other2013)}}</font>
                                                                        </td>
                                                                        <td align="right"><font
                                                                                    size="1">{{MyUtility::formatThousand($row->ngo2013)}}</font>
                                                                        </td>
                                                                        <td align="right"><font
                                                                                    size="1">{{MyUtility::formatThousand($row->own2013+$row->other2013+$row->ngo2013)}}</font>
                                                                        </td>
                                                                        <td align="right"><font
                                                                    ...
                                                                    @if($getSum >0)
                                                                        <tr valign="top" bgcolor="#E8E8FF">
                                                                            ...
                                                                            <td align="right" bgcolor="#ECE9D8"
                                                                                style="padding: 2px">
                                                                                <b><font
                                                                                            size="1">{{MyUtility::formatThousand($TotalOwn2013)}}</font></b>
                                                                            </td>
                                                                            <td align="right" bgcolor="#ECE9D8"
                                                                                style="padding: 2px">
                                                                                <b><font
                                                                            ...
                                                                            <td align="right" bgcolor="#ECE9D8"
                                                                                style="padding: 2px">
                                                                                <b><font
                                                                                            size="1">{{MyUtility::formatThousand($TotalNgo2013)}}</font></b>
                                                                            </td>
                                                                            <td align="right" bgcolor="#ECE9D8"
                                                                                style="padding: 2px">
                                                                                <b><font
                                                                                            size="1">{{MyUtility::formatThousand($Total2013)}}</font></b>
                                                                            </td>
                                                                            <td align="right" bgcolor="#ECE9D8"
                                                                                style="padding: 2px">
                                                                                <b><font
                                                                ...
                                                                @if(count($dsCore) == ($countRID))
                                                                    ...
                                                                    <tr valign="middle" bgcolor="#ECE9D8"
                                                                        class="fontNormal">
                                                                        <td height="25" class="BoldBlue" colspan="3"
                                                                            align="right"
                                                                            style="border-left-color: #CCCCCC; border-left-width: 1px">
                                                                            <font color="#0000FF"><b>
                                                                        ...
                                                                        <td align="right" bgcolor="#ECE9D8"
                                                                            style="padding: 2px"><b>
                                                                                <font size="1"
                                                                                      color="#0000FF">
                                                                                    {{MyUtility::formatThousand($gTotalOwn2013)}}</font></b>
                                                                        </td>
                                                                        <td align="right" bgcolor="#ECE9D8"
                                                                            style="padding: 2px"><b>
                                                                                <font size="1"
                                                                                      color="#0000FF">
                                                                                    {{MyUtility::formatThousand($gTotalOther2013)}}</font></b>
                                                                        </td>
                                                                        <td align="right" bgcolor="#ECE9D8"
                                                                            style="padding: 2px"><b>
                                                                                <font size="1"
                                                                                      color="#0000FF">
                                                                                    {{MyUtility::formatThousand($gTotalNgo2013)}}</font></b>
                                                                        </td>
                                                                        <td align="right" bgcolor="#ECE9D8"
                                                                            style="padding: 2px"><b>
                                                                                <font size="1"
                                                                                      color="#0000FF">
                                                                                    {{MyUtility::formatThousand($gTotal2013)}}</font></b>
                                                                        </td>
                                                                        <td align="right" bgcolor="#ECE9D8"
                                                                            style="padding: 2px"><b>
                                                                                <font size="1"
