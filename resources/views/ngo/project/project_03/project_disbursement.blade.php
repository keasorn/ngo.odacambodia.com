            ...
            <table border="0" width="99%" cellpadding="2" style="border-collapse: collapse">
                ...
                <tr>
                    ...
                    <td width="96%" style="padding: 2px">
                        <p align="right">
                            <a href="/ngo/report/individual_project_preview?PRN={{$PRN}}"
                               target="_blank">
                ...
                <tr>
                    ...
                    <td width="96%"
                        ...
                        <table border="0" width="100%" cellpadding="2" style="border-collapse: collapse">
                            <tr>
                                <td width="129" align="right" style="padding: 2px">
                                    <font color="#0000FF">NGO Name:</font></td>
                                <td style="padding: 2px">
									<input type="text" maxlength="100" value="{{$Project_Org_Name_E}}" name="Org_Name_E" id="Org_Name_E" size="50"></td>
                            </tr>
                            <tr>
                                <td width="129" align="right" style="padding: 2px">
                                    <font color="#0000FF">Contact Name:
                                    </font></td>
                                <td style="padding: 2px"><input type="text" maxlength="50" value="{{$Project_Contact_Name_E}}" name="Contact_Name_E" id="Contact_Name_E" size="50">
                                </td>
                            </tr>
                            <tr>
                                <td width="129" align="right" style="padding: 2px">
                                    <font color="#0000FF">Contact Title:</font></td>
                                <td style="padding: 2px"><input type="text" maxlength="50" value="{{$Project_Contact_Title_E}}" name="Contact_Title_E" id="Contact_Title_E" size="50"></td>
                            </tr>
                            <tr>
                                <td width="129" align="right" style="padding: 2px">
                                    <font color="#0000FF">Phone:
                                    </font></td>
                                <td style="padding: 2px"><input type="text" maxlength="50" value="{{$Project_Tel_No}}" name="Tel_No" id="Tel_No" size="50"></td>
                            </tr>
                            <tr>
                                <td width="129" align="right" style="padding: 2px">
                                    <font color="#0000FF">Email:</font></td>
                                <td style="padding: 2px"><input type="text" maxlength="100" value="{{$Project_eMail}}" name="eMail" id="eMail" size="50"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
