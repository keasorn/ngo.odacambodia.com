        ...
        <tr>
            ...
            <td width="93%" align="right" valign="middle" colspan="6" style="border-left: medium none #CCCCCC; border-right: 1px solid #CCCCCC; border-top: medium none #CCCCCC; border-bottom: 1px solid #CCCCCC; padding: 2px">
                ...
                <table id="table3" border="1" style="border-collapse: collapse" id="table3"
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            ...
                            <input readOnly="true" name="Total2014FTC" id="Total2014FTC" class="TextBoxDisb"
                                   ...
                                   value="{{ MyUtility::formatThousand($Total2014FTC)}}" size="8" maxlength="15"></td>
                        <td style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            align="center" height="24" width="6%">
                        ...
                        <td style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            ...
                            <input readOnly="true" name="Total2015FTC" id="Total2015FTC" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2015FTC)}}" size="8" maxlength="15"></td>
                        <td style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            align="center" height="24" width="6%">
                        ...
                        <td style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            ...
                            <input readOnly="true" name="Total2016FTC" id="Total2016FTC" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2016FTC)}}" size="8" maxlength="15"></td>
                    ...
                    <tr>
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2014ITC" id="Total2014ITC" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2014ITC)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2015ITC" id="Total2015ITC" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2015ITC)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                    ...
                    <tr>
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2014FOA" id="Total2014FOA" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2014FOA)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2015FOA" id="Total2015FOA" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2015FOA)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                    ...
                    <tr>
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2014ERA" id="Total2014ERA" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2014ERA)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2015ERA" id="Total2015ERA" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2015ERA)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                    ...
                    <tr>
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2014NOT" id="Total2014NOT" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2014NOT)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                        ...
                        <td align="center"
                            ...
                            <input readOnly="true" name="Total2015NOT" id="Total2015NOT" class="TextBoxDisb"
                                   style="text-align: right; border:medium none;color:#000080; background-color:#ECE9D8;"
                                   value="{{ MyUtility::formatThousand($Total2015NOT)}}" size="8"
                                   maxlength="15"></td>
                        <td align="center"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px" width="6%">
                    ...
                    <tr>
                        <td class="fontTiny"
                            style="border-left:1px solid #C0C0C0; border-top:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px; border-right-color:#C0C0C0"
                            bgcolor="#ECE9D8" align="center" height="20" width="4%">
                            <b>Total:</b></td>
                        <td class="fontTiny" align="right" bgcolor="#ECE9D8"
                            style="border-color:#C0C0C0; ;  padding-top:1px; padding-bottom:1px"
                            height="20" width="6%">
                            <b>
                        ...
                        <td class="fontTiny" align="right" bgcolor="#ECE9D8"
                            style="border-left:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px; border-right-color:#C0C0C0; border-top-color:#C0C0C0"
                            height="20" width="6%">
                            <b>
                        ...
                        <td class="fontTiny" align="right" bgcolor="#ECE9D8"
                            style="border-right:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px; border-left-color:#C0C0C0; border-top-color:#C0C0C0"
                            height="20" width="6%">
                            <b>
                        ...
                        <td class="fontTiny" align="right" bgcolor="#ECE9D8"
                            style="border-left:1px solid #C0C0C0; border-right:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px; border-top-color:#C0C0C0"
                            height="20" width="6%">
                            <b>
                        ...
                        <td class="fontTiny" align="right"
                            style="border:1px solid #C0C0C0; ;  padding-top:1px; padding-bottom:1px"
...
@endsection
        ...
        function initDis(){
            byid("Own2013ITC").trigger('blur')
            byid("Own2013FTC").trigger('blur')
            byid("Own2013IPA").trigger('blur')
            byid("Own2013FOA").trigger('blur')
            byid("Own2013ERA").trigger('blur')
            byid("Own2013NOT").trigger('blur')
        }
        initDis();
    </script>