	...
	obj.onreadystatechange = function(){
							if (id != "") {
								if (obj.readyState==4 || obj.readyState=="complete"){ 
									...
									if (loading) {			
										var progress = ById("progress"+ id)
										if (progress == null) {
											ById(id).innerHTML ="<img src='/images/small_loading.gif' align='absbottom'><b><font color=red> Loading...</font></b>" ;					
										}
										else {							
											progress.innerHTML ="<img src='/images/small_loading.gif' align='absbottom'><b><font color=red> Loading...</font></b>" ;					
										}
									}
								}
							}
...
function Ajax_SubTableNavigationAsync(url, spanId, initPage , sortColumn, tbl, key){
	try 
	{
		...
		Ajax_UpdatePanelAsync(url,submitValue, spanId, true)
