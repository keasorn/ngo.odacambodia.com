function Epoch(name,mode,targetelement,multiselect){
	...
	function calConfig(){
		...
		self.minDate=new Date(1993,0,1);
	...
	function setLang(){
		...
		self.clearbtn_title='Clear any date selected on the calendar';
...
td.weekObj=new WeekHeading(self,td,week,row)}else{
...
iTop +=(oNode.offsetTop||0)+(oNode.scrollTop||0);
...
iLeft +=(oNode.offsetLeft||0)+(oNode.scrollLeft||0);
		if(oNode.offsetParent){
